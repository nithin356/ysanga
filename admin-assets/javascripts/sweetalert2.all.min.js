!(function (n, t) {
  ...
  var b = function (n) {
      for (var t in n)
        k.isValidParameter(t) || r('Unknown parameter "' + t + '"'),
    ...
    g = function (t) {
      ...
      (e.style.padding = "number" == typeof w ? w + "px" : w),
      ...
      for (
        ...
        u[d].style.background = t.background;
      var f = A(),
        m = L(),
        b = T(),
        g = N(),
      ...
      if (
        ...
        t.backdrop ||
          D([document.documentElement, document.body], o["no-backdrop"]),
        t.text || t.html)
      ) {
        if ("object" === p(t.html))
          if (((b.innerHTML = ""), 0 in t.html))
            for (var v = 0; v in t.html; v++)
              b.appendChild(t.html[v].cloneNode(!0));
      ...
      if (
        (t.position in o && D(f, o[t.position]),
      ...
      t.showCloseButton
        ? (y.setAttribute("aria-label", t.closeButtonAriaLabel), W(y))
        : K(y),
        (e.className = o.popup),
        t.toast
          ? (D([document.documentElement, document.body], o["toast-shown"]),
            D(e, o.toast))
          : D(e, o.modal),
      ...
      t.progressSteps.length
        ? (W(E),
          _(E),
          j >= t.progressSteps.length &&
            r(
              "Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"
            ),
          t.progressSteps.forEach(function (n, e) {
            var a = document.createElement("li");
            if (
              (D(a, o.progresscircle),
              (a.innerHTML = n),
              e === j && D(a, o.activeprogressstep),
              E.appendChild(a),
              e !== t.progressSteps.length - 1)
            ) {
              var s = document.createElement("li");
              D(s, o.progressline),
                (s.style.width = t.progressStepsDistance),
                E.appendChild(s);
            }
          }))
        : K(E);
      ...
      if (t.type) {
        ...
        if ((W(I), t.animation))
          switch (t.type) {
            case "success":
              D(I, "swal2-animate-success-icon"),
                D(
              ...
              break;
            case "error":
              D(I, "swal2-animate-error-icon"),
                D(I.querySelector(".swal2-x-mark"), "swal2-animate-x-mark");
          }
      }
      var X = z();
      t.imageUrl
        ? (X.setAttribute("src", t.imageUrl),
          X.setAttribute("alt", t.imageAlt),
          W(X),
          t.imageWidth
            ? X.setAttribute("width", t.imageWidth)
            : X.removeAttribute("width"),
          t.imageHeight
            ? X.setAttribute("height", t.imageHeight)
            : X.removeAttribute("height"),
          (X.className = o.image),
          t.imageClass && D(X, t.imageClass))
        : K(X),
        t.showCancelButton ? (h.style.display = "inline-block") : K(h),
        t.showConfirmButton ? J(x, "display") : K(x),
        t.showConfirmButton || t.showCancelButton ? W(g) : K(g),
        (x.innerHTML = t.confirmButtonText),
        (h.innerHTML = t.cancelButtonText),
        x.setAttribute("aria-label", t.confirmButtonAriaLabel),
        h.setAttribute("aria-label", t.cancelButtonAriaLabel),
        t.buttonsStyling &&
          ((x.style.backgroundColor = t.confirmButtonColor),
          (h.style.backgroundColor = t.cancelButtonColor)),
        (x.className = o.confirm),
        D(x, t.confirmButtonClass),
        (h.className = o.cancel),
        D(h, t.cancelButtonClass),
        t.buttonsStyling
          ? D([x, h], o.styled)
          : ($([x, h], o.styled),
            (x.style.backgroundColor = x.style.borderLeftColor = x.style.borderRightColor =
              ""),
            (h.style.backgroundColor = h.style.borderLeftColor = h.style.borderRightColor =
              "")),
        !0 === t.animation ? $(e, o.noanimation) : D(e, o.noanimation),
    ...
    x = function () {
      null === y.previousBodyPadding &&
        ...
        (document.body.style.paddingRight = nn() + "px"));
    },
    h = function () {
      if (
        /iPad|iPhone|iPod/.test(navigator.userAgent) &&
        !window.MSStream &&
        !R(document.body, o.iosfix)
      ) {
    ...
    k = function n() {
      ...
      if ("undefined" != typeof window) {
        ...
        switch (p(e[0])) {
          ...
          case "object":
            if (
              (b(e[0]),
              w(r, e[0]),
              (r.extraParams = e[0].extraParams),
              "email" === r.input && null === r.inputValidator)
            ) {
              var l = function (n) {
        ...
        return new Promise(function (t, e) {
          var a = function (e) {
              n.closePopup(r.onClose), t(r.useRejections ? e : { value: e });
            },
            l = function (o) {
              n.closePopup(r.onClose),
                r.useRejections ? e(o) : t({ dismiss: o });
            },
            c = function (t) {
          ...
          var w = function (n) {
            ...
            switch (n) {
              ...
              case "radio":
                return (
                  k.querySelector("." + o.radio + " input:checked") ||
                  k.querySelector("." + o.radio + " input:first-child")
                );
              case "range":
              ...
              b = function (t) {
                ...
                switch (e.type) {
                  ...
                  case "mouseout":
                    r.buttonsStyling &&
                      (p
                        ? (a.style.backgroundColor = r.confirmButtonColor)
                        : d && (i.style.backgroundColor = r.cancelButtonColor));
                    break;
                  case "mousedown":
                    r.buttonsStyling &&
                      (p
                  ...
                  case "click":
                    if (p && n.isVisible())
                      ...
                      d && n.isVisible() && (n.disableButtons(), l("cancel"));
                }
              },
              v = k.querySelectorAll("button"),
              C = 0;
            C < v.length;
            C++
          )
          ...
          if (
            ...
            k.onclick = function (t) {
              t.target !== k ||
                ...
                r.showCancelButton ||
                (r.allowOutsideClick &&
                  (n.closePopup(r.onClose), l("overlay")));
            };
          else {
            var S = !1;
            (k.onmousedown = function () {
              ...
              (d.onmousedown = function () {
                k.onmouseup = function (n) {
                  (k.onmouseup = void 0),
                    (n.target === k || k.contains(n.target)) && (S = !0);
                };
              }),
              (d.onclick = function (n) {
                S
                  ? (S = !1)
                  : n.target === d && r.allowOutsideClick && l("overlay");
              });
          }
          var P = N(),
            E = O(),
          ...
          r.toast && m && ((window.onkeydown = f), (m = !1)),
            r.toast ||
              m ||
              ((f = window.onkeydown),
              (m = !0),
                ...
                if ("Enter" !== e.key || e.isComposing)
                  if ("Tab" === e.key) {
                    ...
                    [
                      ...
                      ? document.activeElement === E && Q(M)
                        ? M.focus()
                        : document.activeElement === M && Q(E) && E.focus()
            ...
            r.buttonsStyling &&
              ((E.style.borderLeftColor = r.confirmButtonColor),
              (E.style.borderRightColor = r.confirmButtonColor)),
            (n.hideLoading = n.disableLoading = function () {
              r.showConfirmButton || (K(E), r.showCancelButton || K(N())),
                $([k, P], o.loading),
            ...
            (n.showValidationError = function (n) {
              ...
              e &&
                ...
                e.setAttribute("aria-describedBy", o.validationerror),
                I(e),
                D(e, o.inputerror));
            }),
            ...
            n.hideLoading(),
            n.resetValidationError(),
            r.input && D(document.body, o["has-input"]);
          for (
            var _ = [
                "input",
                "file",
            ...
            if ((J = w(_[G]))) {
              ...
              for (var an in r.inputAttributes)
                J.setAttribute(an, r.inputAttributes[an]);
            }
          ...
          switch (r.input) {
            ...
            case "tel":
            case "url":
              ((J = U(k, o.input)).value = r.inputValue),
                (J.placeholder = r.inputPlaceholder),
                (J.type = r.input),
                W(J);
              break;
            case "file":
              ((J = U(k, o.file)).placeholder = r.inputPlaceholder),
                (J.type = r.input),
                W(J);
              break;
            case "range":
              ...
              (ln.value = r.inputValue),
                (ln.type = r.input),
                (cn.value = r.inputValue),
                W(rn);
              break;
            case "select":
              var pn = U(k, o.select);
              if (((pn.innerHTML = ""), r.inputPlaceholder)) {
                ...
                (wn.innerHTML = r.inputPlaceholder),
                  (wn.value = ""),
                  (wn.disabled = !0),
                  (wn.selected = !0),
                  pn.appendChild(wn);
              ...
              sn = function (n) {
                for (var t in n) {
                  ...
                  (e.value = t),
                    (e.innerHTML = n[t]),
                    r.inputValue.toString() === t && (e.selected = !0),
                    pn.appendChild(e);
                }
                W(pn), pn.focus();
              };
                ...
                (sn = function (n) {
                  for (var t in n) {
                    ...
                    (e.type = "radio"),
                      (e.name = o.radio),
                      (e.value = t),
                      r.inputValue.toString() === t && (e.checked = !0),
                      (s.innerHTML = n[t]),
                      a.appendChild(e),
                      a.appendChild(s),
                      (a.for = e.id),
            ...
            case "checkbox":
              ...
              (fn.type = "checkbox"),
                (fn.value = 1),
                (fn.id = o.checkbox),
                (fn.checked = Boolean(r.inputValue));
              var mn = dn.getElementsByTagName("span");
              mn.length && dn.removeChild(mn[0]),
                ((mn = document.createElement("span")).innerHTML =
                  r.inputPlaceholder),
                dn.appendChild(mn),
                W(dn);
              break;
            case "textarea":
              ...
              (bn.value = r.inputValue),
                (bn.placeholder = r.inputPlaceholder),
                W(bn);
              break;
            case null:
              break;
          ...
          ("select" !== r.input && "radio" !== r.input) ||
            (r.inputOptions instanceof Promise
              ? (n.showLoading(),
                r.inputOptions.then(function (t) {
                  n.hideLoading(), sn(t);
                }))
              : "object" === p(r.inputOptions)
              ? sn(r.inputOptions)
              : i(
            ...
            (function (n, t, e) {
              var a = A(),
                s = B();
              null !== t && "function" == typeof t && t(s),
                n ? (D(s, o.show), D(a, o.fade), $(s, o.hide)) : $(s, o.fade),
                W(s),
                (a.style.overflowY = "hidden"),
                F && !R(s, o.noanimation)
                  ? s.addEventListener(F, function n() {
                      s.removeEventListener(F, n), (a.style.overflowY = "auto");
                    })
                  : (a.style.overflowY = "auto"),
                D([document.documentElement, document.body, a], o.shown),
                Z() && (x(), h()),
            ...
            })(r.animation, r.onBeforeOpen, r.onOpen),
            r.toast ||
              (r.allowEnterKey
                ? r.focusCancel && Q(M)
                  ? M.focus()
  ...
  (k.isVisible = function () {
    ...
    (k.close = k.closePopup = k.closeModal = k.closeToast = function (n) {
      ...
      if (e) {
        ...
        F && !R(e, o.noanimation)
          ? e.addEventListener(F, function n() {
    ...
    "undefined" != typeof window &&
      "object" === p(window._swalDefaults) &&
      k.setDefaults(window._swalDefaults);
  var y = { previousActiveElement: null, previousBodyPadding: null },
    ...
    H = function () {
      var n = Array.from(
          ...
          return (
            (n = parseInt(n.getAttribute("tabindex"))),
