...
<!-- Theme sweetalert Files -->
<script src="../admin-assets/javascripts/sweetalert2.all.min.js"></script>

<!--crypto JS-->
<script src="../admin-assets/javascripts/crypto-js.min.js"></script>

<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.22/js/jquery.dataTables.js"></script>

<!-- Examples -->
<script src="../admin-assets/javascripts/bootstrap-toggle.min.js"></script>
