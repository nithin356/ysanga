...
if ($count == 0) {
    ...
    if ($insert) {
        ...
        $others = "N/A";
        $insertservice =  mysqli_query($connection, "INSERT INTO ys_user_service (yn_arrival, yn_organisation, yn_time, yn_eventtype, yn_other, yn_created, yn_sid, yn_uid, yn_s_status,yn_bookedby) VALUES ('$arrival', '$noa', '$timeSlot','$toe', '$others', '$created', '$sid', '$uid', '$status', '$id')");
        if (!$insertservice) {
