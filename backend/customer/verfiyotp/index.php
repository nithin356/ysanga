...
$phone = $_POST['phone'];
$otp = $_POST['otp'];
$QueryVerifyOTP = mysqli_query($connection, "SELECT * FROM yn_user WHERE yn_phone='$phone'");
...
if ($count == 1) {
    ...
    if ($otp == $checkotp) {
        ...
        $deleteVerifyOTP = mysqli_query($connection, "UPDATE yn_user set yn_otp='' WHERE yn_phone = '$phone'");
        $_SESSION['yn_uid'] = $uid;
