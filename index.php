			...
			<div class="container">
				<div class="row">
					<div class="hom1-title">
						...
						<p>Book your auditoriums.</p>
					</div>
				</div>
				<div class="row">
					<div class="to-ho-hotel getService">
						<!-- Services GRID -->
					...
					<div>
						<div class="col-md-3 n2-event">
							...
							<div class="n22-event"> <a href="#!">
									<h4>Wedding Halls</h4>
								</a> <span class="event-date">Capacity: 500,</span> <span class="event-by"> Price: $900</span>
						...
						<div class="col-md-3 n2-event">
							...
							<div class="n22-event"> <a href="#!">
								...
								</a> <span class="event-date">Capacity: 500,</span> <span class="event-by"> Price: $700</span>
								<p>undergraduate applicants are admitted on a need-blind basis, and the university offers undergraduate applicants</p>
								<!--event SHARE-->
								<div class="event-share">
									<ul>
						...
						<div class="col-md-3 n2-event">
							...
							<div class="n22-event"> <a href="#!">
									<h4>Social Event</h4>
								</a> <span class="event-date">Capacity: 420,</span> <span class="event-by"> Price: $750</span>
								<p>undergraduate applicants are admitted on a need-blind basis, and the university offers undergraduate applicants</p>
								<!--event SHARE-->
								<div class="event-share">
									<ul>
						...
						<div class="col-md-3 n2-event">
							...
							<div class="n22-event"> <a href="#!">
								...
								</a> <span class="event-date">Capacity: 240,</span> <span class="event-by"> Price: $500</span>
								<p>undergraduate applicants are admitted on a need-blind basis, and the university offers undergraduate applicants</p>
								<!--event SHARE-->
								<div class="event-share">
									<ul>
